...
const Kontakt3 = () => {
  ...
  return (
    ...
    >
      <div
        data-aos="zoom-in"
        className="text-textgray mx-0 sm:mx-4 mb-12 sm:w-1/2"
      >
        <h2 className="text-header text-3xl sm:text-4xl font-extrabold mb-4">
          Kontakt
        </h2>
        ...
        <p className="text-paragraph sm:mr-8">
          ...
          nostrum ipsum molestias deleniti fugiat! Quidem quo temporibus,
          delectus ad a facere magnam sunt libero numquam. Tempore hic esse
          praesentium ea.
        </p>
      </div>
      <div className="flex flex-col items-center sm:flex-row sm:mb-0 mx-0 sm:mx-4">
        ...
        <div
          data-aos="zoom-in"
          className="bg-gray-500 schatten sm:w-1/2 w-full sm:px-0 md:px-4 p-4 rounded-lg"
        >
